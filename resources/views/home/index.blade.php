  ...
  <section id="hero">
    <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
      ...
      @foreach ($sliders as $index => $slider)
        <!-- Slide 1 -->
        <div class="carousel-item {{$index === 0 ? 'active' : ''}}" style="background-image: url(assets/img/{{$slider->image}})">
          <div class="container">
            <h2>{{$slider->title}}</h2>
        ...
        @foreach ($news as $news)
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              <div class="icon">
              <img src="/image/{{$news->image}}" alt="" class="img-fluid" width="80">
              </div>
              <h4>{{$news->title}}</h4>
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
            <div class="count-box">
              ...
              <span data-purecounter-start="0" data-purecounter-end="85000" data-purecounter-duration="1" class="purecounter"></span>

              <p><strong>Luas Wilayah</strong> desa Sumberkedawung</p>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
            <div class="count-box">
              ...
              <p><strong>Jumlah Kartu Keluarga</strong> di desa Sumberkedawung</p>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
            <div class="count-box">
              ...
              <p><strong>Jumlah Penduduk</strong> di desa Sumberkedawung</p>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
            <div class="count-box">
              ...
              <p><strong>Prestasi Desa</strong> Sumberkedawung</p>
            </div>
          </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="gallery-slider swiper">
          ...
          @foreach ($galeri as $galeri)
            <div class="swiper-slide"><a class="gallery-lightbox" href="assets/img/{{$galeri->image}}">
              <img src="assets/img/{{$galeri->image}}" class="img-fluid" alt=""></a></div>
            </div>
            @endforeach
